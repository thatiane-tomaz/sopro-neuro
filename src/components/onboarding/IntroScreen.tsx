  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center px-6 pt-14 pb-10">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center w-full max-w-sm">
        <div className="text-center animate-fade-in -translate-y-6" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="w-full flex items-center justify-center gap-2 mt-6 mb-6 animate-fade-in" style={{ animationDelay: "0.35s" }}>

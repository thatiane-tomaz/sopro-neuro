...
const stories: Story[] = [
  ...
  },
  {
    ...
    description: 'Um apoio treinado para te ajudar no processo',
  ...
  },
  {
    ...
    highlights: [
      { icon: 'check', text: 'Evita passar por múltiplos ciclos de abstinência' },
            ...
            <div className={`text-center ${currentStory === 0 ? 'mb-2' : 'mb-3'}`}>
              {current.headerIcon && (
                <div className={`mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-white/15 backdrop-blur-sm ring-1 ring-white/20 ${currentStory === 0 ? 'mb-3' : 'mb-4'}`}>
                  ...
                  {current.headerIcon === 'brain-side' && <Brain className="h-7 w-7 text-white" />}
                </div>
              )}

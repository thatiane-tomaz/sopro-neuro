...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Request received", { email, confirmationUrl });
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="color: #4a5568; font-size: 16px; line-height: 1.8; margin: 0 0 30px 0;">
                Olá <strong>${name}</strong>! Você está quase lá. Para completar seu cadastro no <strong>Sopro Neuro</strong>, confirme seu email clicando no botão abaixo:
              </p>
